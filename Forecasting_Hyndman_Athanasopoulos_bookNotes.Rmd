...
Now we will allow the errors from a regression to contain autocorrelation. in order to do that we replace $\varepsilon_t$ with $\eta_t$ which is assumed to follow an ARIMA model. 
\begin{align*}
